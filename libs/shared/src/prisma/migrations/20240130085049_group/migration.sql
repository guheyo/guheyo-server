/*
  ...
  - You are about to drop the column `discordGroupId` on the `DiscordMessage` table. All the data in the column will be lost.
  ...
  - Added the required column `discordGuildId` to the `DiscordMessage` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "DiscordMessage" DROP COLUMN "discordGroupId",
