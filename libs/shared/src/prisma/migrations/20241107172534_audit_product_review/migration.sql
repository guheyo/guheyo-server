...
-- -- Audit trigger on FollowUser
-- CREATE TRIGGER audit_follow_user
-- AFTER INSERT OR UPDATE OR DELETE ON "public"."FollowUser"
--     FOR EACH ROW EXECUTE FUNCTION "audit"."audit_trail"();

-- -- Audit trigger on SocialAccountConflict
-- CREATE TRIGGER audit_social_account_conflict
-- AFTER INSERT OR UPDATE OR DELETE ON "public"."SocialAccountConflict"
--     FOR EACH ROW EXECUTE FUNCTION "audit"."audit_trail"();
