...
module.exports = {
  ...
  output: {
    filename: 'index.js',
    path: path.resolve(__dirname, '../../../../dist/apps/lambda/webhook-auction-ending-soon'),
      ...
      patterns: [
        {
          ...
          to: path.resolve(__dirname, '../../../../dist/apps/lambda/webhook-auction-ending-soon/libquery_engine-linux-arm64-openssl-3.0.x.so.node'),
        },
        {
          from: path.resolve(__dirname, '../../../../node_modules/.prisma/client/schema.prisma'),
          to: path.resolve(__dirname, '../../../../dist/apps/lambda/webhook-auction-ending-soon/schema.prisma'),
        },
      ],
    }),
  ],
